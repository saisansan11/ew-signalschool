...
class _SignalLibraryScreenState extends State<SignalLibraryScreen>
  ...
  final List<SignalData> _signalDatabase = [
    ...
    const SignalData(
      ...
      name: 'GLONASS L1',
      nameThai: 'กลอนาส L1',
      description: 'ระบบนำทางดาวเทียมรัสเซีย ย่านความถี่ L1',
      frequencyMin: 1598.0625,
      frequencyMax: 1605.375,
      category: SignalCategory.navigation,
      modulation: ModulationType.dsss,
      waveform: WaveformType.sine,
      bandwidth: 7.875,
      usage: 'Navigation, Positioning, Timing',
      ewNotes: 'ใช้ FDMA ต่างจาก GPS ที่ใช้ CDMA สามารถถูก Jam/Spoof ได้',
      tags: ['GNSS', 'Russia', 'FDMA'],
    ),
    ...
    const SignalData(
      id: 'beidou_b1',
      name: 'BeiDou B1',
      nameThai: 'เป่ยโต่ว B1',
      description: 'ระบบนำทางดาวเทียมจีน ย่านความถี่ B1',
      frequencyMin: 1559.052,
      frequencyMax: 1591.788,
      category: SignalCategory.navigation,
      modulation: ModulationType.dsss,
      waveform: WaveformType.sine,
      bandwidth: 32.736,
      usage: 'Navigation, Positioning, Timing',
      ewNotes: 'ใช้งานคู่กับ GPS สำหรับความแม่นยำและ Redundancy',
      tags: ['GNSS', 'China', 'CDMA'],
    ),
    ...
    const SignalData(
      id: 'galileo_e1',
      name: 'Galileo E1',
      nameThai: 'กาลิเลโอ E1',
      description: 'ระบบนำทางดาวเทียมยุโรป ย่านความถี่ E1',
      frequencyMin: 1559,
      frequencyMax: 1591,
      category: SignalCategory.navigation,
      modulation: ModulationType.dsss,
      waveform: WaveformType.sine,
      bandwidth: 32,
      usage: 'Navigation, Positioning, Timing, SAR',
      ewNotes: 'มีบริการ Public Regulated Service สำหรับทหาร/รัฐบาล',
      tags: ['GNSS', 'EU', 'Civil'],
    ),
    ...
    const SignalData(
      ...
      waveform: WaveformType.pulse,
      bandwidth: 1,
      usage: 'Aircraft Position Broadcasting, ATC',
      ewNotes: 'ไม่มีการเข้ารหัส สามารถดักฟังและ Spoof ได้ง่าย',
      tags: ['Aviation', 'Surveillance', 'Unencrypted'],
    ),
    ...
    const SignalData(
      id: 'lte_band3',
      name: 'LTE Band 3 (4G)',
      nameThai: 'แอลทีอี แบนด์ 3',
      description: '4G LTE ย่านความถี่ 1800 MHz',
      frequencyMin: 1710,
      frequencyMax: 1880,
      category: SignalCategory.communication,
      modulation: ModulationType.ofdm,
      waveform: WaveformType.sine,
      bandwidth: 20,
      usage: 'Mobile Data, Voice over LTE',
      ewNotes: 'แบนด์กว้าง OFDM ทำให้ Jam ยาก แต่สามารถ Jam baseband ได้',
      tags: ['Cellular', '4G', 'Commercial'],
    ),
    ...
    const SignalData(
      id: '5g_nr_n78',
      name: '5G NR n78',
      nameThai: '5G เอ็นอาร์',
      description: '5G New Radio ย่านความถี่ 3.5 GHz',
      frequencyMin: 3300,
      frequencyMax: 3800,
      category: SignalCategory.communication,
      modulation: ModulationType.ofdm,
      waveform: WaveformType.sine,
      bandwidth: 100,
      usage: 'High-speed Data, IoT, Industrial',
      ewNotes: 'Beamforming และ Massive MIMO ทำให้ยากต่อการ Jam',
      tags: ['Cellular', '5G', 'Commercial'],
    ),
    ...
    const SignalData(
      ...
      nameThai: 'อิริเดียม',
      description: 'ระบบโทรศัพท์ผ่านดาวเทียม Iridium',
      frequencyMin: 1616,
      frequencyMax: 1626.5,
      category: SignalCategory.communication,
      modulation: ModulationType.psk,
      waveform: WaveformType.burst,
      bandwidth: 10.5,
      usage: 'Satellite Phone, Short Burst Data',
      ewNotes: 'LEO constellation ใช้เวลาส่งสั้น ยากต่อการ Intercept',
      tags: ['Satellite', 'LEO', 'Global'],
    ),

    // Thuraya
    const SignalData(
      id: 'thuraya',
      name: 'Thuraya Satellite',
      nameThai: 'ทูรายา',
      description: 'ระบบโทรศัพท์ผ่านดาวเทียม Thuraya',
      frequencyMin: 1525,
      frequencyMax: 1559,
      category: SignalCategory.communication,
      modulation: ModulationType.psk,
      waveform: WaveformType.burst,
      bandwidth: 34,
      usage: 'Satellite Phone, GPS, Data',
      ewNotes: 'GEO satellite ครอบคลุม Europe-Asia-Africa',
      tags: ['Satellite', 'GEO', 'Regional'],
    ),
    ...
    const SignalData(
      ...
      name: 'P25 Phase II',
      nameThai: 'พี-25',
      description: 'APCO Project 25 Digital Radio',
      frequencyMin: 764,
      frequencyMax: 870,
      category: SignalCategory.communication,
      modulation: ModulationType.fsk,
      ...
      bandwidth: 12.5,
      usage: 'Public Safety, Emergency Services',
      ewNotes: 'Trunked radio มีการเข้ารหัส AES ยากต่อการดักฟัง',
      tags: ['Public Safety', 'Digital', 'Trunked'],
    ),
    ...
    const SignalData(
      ...
      name: 'TETRA',
      nameThai: 'เทตร้า',
      description: 'Terrestrial Trunked Radio',
      frequencyMin: 380,
      frequencyMax: 400,
      category: SignalCategory.communication,
      modulation: ModulationType.psk,
      waveform: WaveformType.burst,
      bandwidth: 25,
      usage: 'European Public Safety, Transport',
      ewNotes: 'End-to-end encryption มีความปลอดภัยสูง',
      tags: ['Public Safety', 'EU', 'Trunked'],
    ),

    // DMR
    const SignalData(
      id: 'dmr',
      name: 'DMR (Digital Mobile Radio)',
      nameThai: 'ดีเอ็มอาร์',
      description: 'Digital Mobile Radio ETSI Standard',
      frequencyMin: 136,
      frequencyMax: 470,
      category: SignalCategory.communication,
      modulation: ModulationType.fsk,
      waveform: WaveformType.square,
      bandwidth: 12.5,
      usage: 'Commercial, Industrial, Amateur',
      ewNotes: 'TDMA 2-slot ประหยัด spectrum สามารถดักฟังได้ถ้าไม่เข้ารหัส',
      tags: ['Digital Radio', 'TDMA', 'Commercial'],
    ),
    ...
    const SignalData(
      id: 'prc152a',
      name: 'AN/PRC-152A',
      nameThai: 'แอน/พีอาร์ซี-152เอ',
      description: 'Harris Falcon III Multiband Radio',
      frequencyMin: 30,
      frequencyMax: 512,
      category: SignalCategory.military,
      modulation: ModulationType.fhss,
      ...
      bandwidth: 25,
      isMilitary: true,
      usage: 'Tactical Voice/Data, SATCOM',
      ewNotes: 'HAVEQUICK + SINCGARS มี Anti-Jam ระดับสูง',
      tags: ['Tactical', 'Multiband', 'US'],
    ),
    ...
    const SignalData(
      id: 'prc117g',
      name: 'AN/PRC-117G',
      nameThai: 'แอน/พีอาร์ซี-117จี',
      description: 'Harris Falcon III Wideband Manpack',
      frequencyMin: 30,
      frequencyMax: 2000,
      category: SignalCategory.military,
      modulation: ModulationType.fhss,
      ...
      bandwidth: 5000,
      isMilitary: true,
      usage: 'Wideband Data, SATCOM, Voice',
      ewNotes: 'Software Defined Radio รองรับหลาย waveform',
      tags: ['SDR', 'Wideband', 'US'],
    ),
    ...
    const SignalData(
      id: 'hf_nvis',
      name: 'HF NVIS',
      nameThai: 'เอชเอฟ เอ็นวีไอเอส',
      description: 'Near Vertical Incidence Skywave',
      frequencyMin: 2,
      frequencyMax: 10,
      category: SignalCategory.communication,
      ...
      waveform: WaveformType.sine,
      bandwidth: 3,
      usage: 'Regional HF Communications (300-500km)',
      ewNotes: 'ใช้ ionosphere สะท้อน ไม่ต้องการ infrastructure',
      tags: ['HF', 'Skywave', 'Regional'],
    ),

    // Starlink
    const SignalData(
      id: 'starlink',
      name: 'Starlink Ku-Band',
      nameThai: 'สตาร์ลิงค์',
      description: 'SpaceX LEO Satellite Internet',
      frequencyMin: 10700,
      frequencyMax: 12700,
      category: SignalCategory.communication,
      modulation: ModulationType.ofdm,
      waveform: WaveformType.sine,
      bandwidth: 250,
      usage: 'Satellite Broadband Internet',
      ewNotes: 'LEO constellation มี low latency ใช้งานทหารได้',
      tags: ['Satellite', 'LEO', 'Broadband'],
    ),

    // Mode S Transponder
    const SignalData(
      id: 'mode_s',
      name: 'Mode S Transponder',
      nameThai: 'โหมด เอส',
      description: 'Secondary Surveillance Radar Reply',
      frequencyMin: 1030,
      frequencyMax: 1090,
      category: SignalCategory.radar,
      modulation: ModulationType.psk,
      waveform: WaveformType.pulse,
      bandwidth: 1,
      usage: 'Aircraft Identification, TCAS',
      ewNotes: 'ส่งข้อมูลเครื่องบิน สามารถ Spoof ได้',
      tags: ['Aviation', 'SSR', 'IFF'],
    ),
    ...
    const SignalData(
      id: 'iff_mode5',
      name: 'IFF Mode 5',
      nameThai: 'ไอเอฟเอฟ โหมด 5',
      description: 'NATO Identification Friend or Foe',
      frequencyMin: 1030,
      frequencyMax: 1090,
      category: SignalCategory.military,
      modulation: ModulationType.dsss,
      ...
      bandwidth: 3,
      isMilitary: true,
      usage: 'Combat Identification, Blue Force Tracking',
      ewNotes: 'Encrypted spread spectrum ยากต่อการ Spoof',
      tags: ['IFF', 'NATO', 'Encrypted'],
    ),
    ...
    const SignalData(
      id: 'r187p1',
      name: 'R-187P1 Azart',
      nameThai: 'อาร์-187พี1 อาซาร์ต',
      description: 'Russian Software Defined Radio',
      frequencyMin: 27,
      frequencyMax: 520,
      category: SignalCategory.military,
      modulation: ModulationType.fhss,
      ...
      bandwidth: 25,
      isMilitary: true,
      usage: 'Russian Military Tactical Communications',
      ewNotes: 'SDR รุ่นใหม่ของรัสเซีย มี Anti-Jam ดีขึ้นจากรุ่นเก่า',
      tags: ['SDR', 'Russia', 'Tactical'],
    ),
  ];
}
