...
class _InteractiveScenariosScreenState
  ...
  final List<ScenarioData> _scenarios = [
    ...
    const ScenarioData(
      id: 'ad_loitering',
      title: 'Loitering Munition Defense',
      titleThai: 'ป้องกัน Kamikaze Drone',
      description:
          'ป้องกันการโจมตีจาก Loitering Munition เช่น Switchblade, Lancet',
      category: ScenarioCategory.antiDrone,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 20,
      objectives: [
        'ตรวจจับ Loitering Munition ก่อนเข้าโจมตี',
        'รบกวนระบบ GPS และ Control Link',
        'ป้องกันเป้าหมายสำคัญ',
      ],
      skills: ['Early Warning', 'Multi-Band Jamming', 'GPS Denial'],
      xpReward: 400,
      missionType: 'anti_drone',
      isNew: true,
    ),
    const ScenarioData(
      id: 'ad_night',
      title: 'Night Counter-UAS',
      titleThai: 'ต่อต้านโดรนกลางคืน',
      description: 'ปฏิบัติการต่อต้านโดรนในเวลากลางคืน ใช้ RF Detection เป็นหลัก',
      category: ScenarioCategory.antiDrone,
      difficulty: ScenarioDifficulty.intermediate,
      estimatedMinutes: 15,
      objectives: [
        'ตรวจจับโดรนโดยไม่พึ่ง Visual',
        'ใช้ RF Signature ระบุตัวตน',
        'ทำลายภัยคุกคามก่อนเข้าใกล้',
      ],
      skills: ['RF Detection', 'Signal Analysis', 'Night Operations'],
      xpReward: 250,
      missionType: 'anti_drone',
    ),
    ...
    const ScenarioData(
      id: 'si_satellite',
      title: 'SATCOM Interception',
      titleThai: 'ดักสัญญาณดาวเทียม',
      description: 'ฝึกการดักฟังและวิเคราะห์สัญญาณสื่อสารผ่านดาวเทียม',
      category: ScenarioCategory.sigint,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 25,
      objectives: [
        'ตรวจจับสัญญาณ SATCOM',
        'วิเคราะห์ประเภทดาวเทียม (Iridium/Thuraya)',
        'ระบุตำแหน่งผู้ใช้งาน',
      ],
      skills: ['SATCOM Analysis', 'Satellite ID', 'Geolocation'],
      xpReward: 400,
      missionType: 'sigint',
    ),
    const ScenarioData(
      ...
      titleThai: 'ข่าวกรองโทรศัพท์มือถือ',
      description: 'วิเคราะห์สัญญาณ 4G/5G เพื่อหาตำแหน่งเป้าหมาย',
      category: ScenarioCategory.sigint,
      difficulty: ScenarioDifficulty.intermediate,
      estimatedMinutes: 15,
      objectives: [
        'ตรวจจับสัญญาณ LTE',
        'ระบุ Cell Tower ที่ใช้งาน',
        'ประมาณตำแหน่งเป้าหมาย',
      ],
      skills: ['LTE Analysis', 'Cell ID', 'Triangulation'],
      xpReward: 200,
      missionType: 'sigint',
      isNew: true,
    ),

    // GPS Warfare Advanced
    const ScenarioData(
      id: 'gps_spoof',
      title: 'GPS Spoofing Detection',
      titleThai: 'ตรวจจับ GPS Spoofing',
      description: 'ฝึกการตรวจจับและแก้ไขสถานการณ์เมื่อถูก GPS Spoofing',
      category: ScenarioCategory.gpsWarfare,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 20,
      objectives: [
        'ระบุอาการ GPS Spoofing',
        'ใช้วิธี Cross-Check หลายระบบ',
        'นำทางด้วยวิธีอื่นทดแทน',
      ],
      skills: ['Spoofing Detection', 'Multi-GNSS', 'Dead Reckoning'],
      xpReward: 350,
      missionType: 'gps_mission',
    ),
    const ScenarioData(
      id: 'gps_precision',
      title: 'Precision GPS Denial',
      titleThai: 'รบกวน GPS แบบแม่นยำ',
      description: 'ฝึกการรบกวน GPS เฉพาะพื้นที่โดยไม่กระทบฝ่ายเรา',
      category: ScenarioCategory.gpsWarfare,
      difficulty: ScenarioDifficulty.intermediate,
      estimatedMinutes: 15,
      objectives: [
        'ตั้งค่า Directional Antenna',
        'รบกวนเฉพาะพื้นที่เป้าหมาย',
        'ป้องกันฝ่ายเราไม่ให้ถูกกระทบ',
      ],
      skills: ['Directional Jamming', 'Power Control', 'Area Denial'],
      xpReward: 250,
      missionType: 'gps_mission',
    ),

    // Comm Jamming Advanced
    const ScenarioData(
      id: 'cj_tactical',
      title: 'Tactical Radio Jamming',
      titleThai: 'รบกวนวิทยุยุทธวิธี',
      description: 'รบกวนวิทยุทหารของข้าศึก ขณะรักษาการสื่อสารฝ่ายเรา',
      category: ScenarioCategory.commJamming,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 20,
      objectives: [
        'ระบุความถี่วิทยุข้าศึก',
        'ใช้ Reactive Jamming',
        'ป้องกันการสื่อสารฝ่ายเรา',
      ],
      skills: ['ESM', 'Reactive Jamming', 'Frequency Deconfliction'],
      xpReward: 350,
      missionType: 'convoy_protection',
    ),
    const ScenarioData(
      id: 'cj_vip',
      title: 'VIP Protection Jamming',
      titleThai: 'ป้องกัน VIP ด้วย Jamming',
      description: 'สร้างเกราะ EW รอบขบวน VIP เพื่อป้องกัน RCIED และโดรน',
      category: ScenarioCategory.commJamming,
      difficulty: ScenarioDifficulty.intermediate,
      estimatedMinutes: 15,
      objectives: [
        'ตั้ง Protective Bubble รอบ VIP',
        'รบกวน RCIED Frequencies',
        'รักษา Internal Comms ของฝ่ายเรา',
      ],
      skills: ['Protective Jamming', 'RCIED Counter', 'Comms Management'],
      xpReward: 250,
      missionType: 'convoy_protection',
      isNew: true,
    ),

    // Radar Operations Extended
    const ScenarioData(
      id: 'ro_sead',
      title: 'SEAD Support',
      titleThai: 'สนับสนุน SEAD',
      description: 'สนับสนุนภารกิจ Suppression of Enemy Air Defense',
      category: ScenarioCategory.radarOps,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 25,
      objectives: [
        'ตรวจจับ SAM Radar',
        'วิเคราะห์ Radar Parameters',
        'ส่งข้อมูลให้หน่วยโจมตี',
      ],
      skills: ['ELINT', 'Threat Analysis', 'Data Fusion'],
      xpReward: 450,
      missionType: 'sigint',
    ),
    const ScenarioData(
      id: 'ro_maritime',
      title: 'Maritime EW',
      titleThai: 'สงครามอิเล็กทรอนิกส์ทางทะเล',
      description: 'ปฏิบัติการ EW ในสภาพแวดล้อมทางทะเล',
      category: ScenarioCategory.radarOps,
      difficulty: ScenarioDifficulty.intermediate,
      estimatedMinutes: 20,
      objectives: [
        'ตรวจจับเรดาร์เรือรบ',
        'วิเคราะห์ภัยคุกคามทางทะเล',
        'ปกป้องกองเรือจาก Anti-Ship Missile',
      ],
      skills: ['Naval Radar', 'Ship ID', 'Missile Warning'],
      xpReward: 300,
      missionType: 'sigint',
    ),
    ...
    const ScenarioData(
      ...
      titleThai: 'ปฏิบัติการร่วม',
      description: 'ประสานการใช้ EW กับหน่วยภาคพื้นในการเข้าตี',
      category: ScenarioCategory.commJamming,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 30,
      objectives: [
        'รบกวนการสื่อสารข้าศึก',
        'ปิดบัง GPS ในพื้นที่เป้าหมาย',
        'ป้องกันโดรนลาดตระเวน',
        'รักษาการสื่อสารฝ่ายเรา',
      ],
      skills: ['Multi-Domain EW', 'Synchronization', 'Battle Management'],
      xpReward: 500,
      missionType: 'convoy_protection',
      isLocked: true,
    ),
    const ScenarioData(
      id: 'ca_defense',
      title: 'Integrated Air Defense',
      titleThai: 'ป้องกันภัยทางอากาศบูรณาการ',
      description: 'ประสาน EW กับระบบป้องกันภัยทางอากาศ',
      category: ScenarioCategory.radarOps,
      difficulty: ScenarioDifficulty.advanced,
      estimatedMinutes: 25,
      objectives: [
        'ตรวจจับภัยคุกคามทางอากาศ',
        'ประสานกับหน่วย SAM',
        'ใช้ Soft-Kill และ Hard-Kill ร่วมกัน',
      ],
      skills: ['Air Defense', 'C2 Integration', 'Multi-Layer Defense'],
      xpReward: 450,
      missionType: 'sigint',
    ),
  ];
